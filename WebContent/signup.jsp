			...
			<div id="upper" class="curved container">
	                ...
	                <div class="curved container">
	                 ...
	                 <div  class="curved container">
						...
						<form:form method="POST" modelAttribute="signupData" action="signup">
	  
					<table>
						<tr>
							<td>email:</td>
							<td><form:input type='text' path="email" name='username' value=''/>
							</td>
						</tr>
						<tr>
							<td>First Name:</td>
							<td><form:input type='text' path="firstname" name='username' value=''/>
							</td>
						</tr>
						
						<tr>
							<td>Last Name:</td>
							<td><form:input type='text' path="lastname" name='username' value=''/>
							</td>
						</tr>
						...
						<tr>
							...
							<form:select path="citizenshipCountry" id="citizenshipCountry" type="String">
							
							<form:option value="" label="--Choose The Citizenship Country--"></form:option>
							
							<c:forEach var="item" items="${signupData.countryList}">
						...
						<tr>
							...
							<input name="reset" type="reset" value="Reset" style="background-color:blue;color:orange;"/>
							</td>	
						</tr>		
					</table>
