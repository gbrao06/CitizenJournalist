...
<body>
	 ...
	 <div id="wrapper">
            ...
            <div id="navigation" class="curved container">
                <span id="nav-home"><a href="signup">Signup</a></span>
                <span id="nav-hosts"><a href="liveshares">Search Regional Stories</a></span>
		...
		<form:form name='f' modelAttribute="loginData" method='POST'>
 
		<table>
			<tr>
				<td>User:</td>
				<td><form:input type='text' path="username" name='j_username' value=''/>
				</td>
			
				<td>Password:</td>
				<td><form:input path='passwd' type='password' name='j_password' />
				</td>
