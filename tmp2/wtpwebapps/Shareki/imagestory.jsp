...
<body onload='document.f.j_username.focus();'>
	 ...
	 <div id="wrapper">
            ...
            <div id="navigation" class="curved container">
                <span id="nav-home"><a href="../mystories">MyShares</a></span>
	...
	<div id="upper3" class="curved container">
	     <div id="congrats3" class="curved container">
	        ...
	        <div class="col80" style="border:1px solid green; margin: 1;">
	    
	    	<output style="align:left;background-color:yellow;">${imageStoryContainer.newsItem.lastUpdated}</output>
	    	
	    	<output style="align:left;background-color:orange;">::${imageStoryContainer.newsItem.title}::</output>
	    	
	    	<output style="align:left;background-color:cyan;">${imageStoryContainer.newsItem.news}</output>
	    	
		    <img src="data:image/png;base64,${imageStoryContainer.imagetBase64()}" alt="${imageStoryContainer.newsItem.title}" width="80%" height="80%"/>
