...
<body onload='document.f.j_username.focus();'>
	 ...
	 <div id="wrapper">
            ...
            <div id="navigation" class="curved container">
                ...
                <span id="nav-examples"><a href="villageehelps">VillageEmergencies</a></span>
                <span id="nav-examples"><a href="cityehelps">CityEmergencies</a></span>
		...
		method='POST'>
			...
			<div id="asf-box">
                ...
                <div class="curved container">
                        <br/>
                        <h2 style="color: black;background-color:orange;">Share Your Emergency Here</h2>
                        <h4 style="color: black;background-color:cyan;">Post a Personal Emergency, like requirement of blood, seeking help from volunteers</h4>
                		
                        <h4 style="color: black;background-color:cyan;"> Posting a news to your village, City, Alert communities on out break of deceases</h4>
