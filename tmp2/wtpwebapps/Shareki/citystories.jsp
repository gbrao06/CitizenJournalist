...
<body onload='document.f.j_username.focus();'>
	 ...
	 <div id="wrapper">
            ...
            <div id="navigation" class="curved container">
                <span id="nav-home"><a href="villagestories">VillageShares</a></span>
                <span id="nav-home"><a href="cityehelps">CityEmergencies</a></span>
	...
	<div id="upper2" class="curved container">
	     <div id="congrats" class="curved container">
	  		...
	  		<form:form method="POST" modelAttribute="cityStoryContainer"
				enctype="multipart/form-data" action="citystories">
			...
			<output style="background-color:orange">${cityStoryContainer.dataSelector.strSelectedCity}</output>
	...
	<div id="upper3" class="curved container">
	     <div id="congrats3" class="curved container">
	        		<c:forEach items="${cityStoryContainer.listNews}" var="item">
		  
	        <div class="col20" style="border:1px solid green; margin: 1;">
		
		    <output style="align:left;background-color:yellow;">Dated:${item.lastUpdated}</output>
	    	
			<output style="align:left;background-color:orange;">::${item.title}::${item.newsid}</output>
	    		
	    	<a href="imagestory/${item.newsid}">
		    	<img src="data:image/png;base64,${cityStoryContainer.imagetBase64(item)}" alt="${item.title}"/>
		  	</a>
