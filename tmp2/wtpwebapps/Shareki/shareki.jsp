...
<body onload='document.f.j_username.focus();'>
		...
		method='POST'>
			...
			<div id="upper" class="curved container">
                ...
                <div id="congrats" class="curved container">
        			...
        			<h2>It is My Social Responsibility. I am an InforHand</h2>
  ...
  <form:form method="POST" modelAttribute="dataSelector"
...
<form:select path="strSelectedCity" id="strSelectedCity" type="String">

<form:option value="" label="--Choose The Nearest City--"></form:option>

<c:forEach var="item" items="${dataSelector.cityList}">
...
<output>${dataSelector.strSelectedCity}</output>

<div class="curved container">  

<output style="background-color:orange">Select Incident Village</output>
<form:input path="strSelectedVillage" type="String" name="data" value="${dataSelector.strSelectedVillage}" style="background-color:white;"/>
		

<output style="backgroun-color:yellow">selected Village:</output>

<output>${dataSelector.strSelectedVillage}</output>

<output>Choose File Less than 5 MB</output>
...
<!--  <img src="<%=session.getAttribute("uploadedFileName")%>" width="80%" height="80%" align="right" alt="Upload Image" />-->	
	...
	<img src="<%=session.getAttribute("uploadedFileName")%>" width="100%" height="100%" align="right" alt="Upload Image"/>
...
<form:textarea path="dataDescription" rows="8" cols="60" name="datadesc" id="datadesc"/> 
<output style="background-color:orange">Image Story</output>
...
<!--  <input type="submit" name="submit" value="Submit" style="background-color:blue;color:yellow;">-->
			...
			<div id="middle" class="curved container">
                ...
                <div class="col25">
                    <div class="container">
                        <p><a href="">NGOs</a></p>
                        <p><a href="">BloodBanks</a></p>
                        <p><a href="">Societies</a></p>
                        
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
                        <p><a href="">Social Metrics</a></p>
                        <p><a href="">Search</a></p>
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
                        <p><a href="">InforHands</a></p>
                        <p><a href="">News Agents</a></p>
                        
                    </div>
                </div>
                <div class="col25">
                    <div class="container">
                        <p><a href="">My Village</a></p>
                        <p><a href="">My City</a></p>
                    </div>
                </div>
                <br class="separator" />
            </div>
