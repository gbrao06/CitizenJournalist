...
<body onload='document.f.j_username.focus();'>
	 ...
	 <div id="wrapper">
            ...
            <div id="navigation" class="curved container">
                ...
                <span id="nav-home"><a href="villageehelps">VillageEmergencies</a></span>
	...
	<div id="upper3" class="curved container">
	     <div id="congrats3" class="curved container">
	        	...
	        	<c:forEach items="${cityStoryContainer.cityENews}" var="item">
	    ...
	    <div class="col20" style="border:1px solid green; margin: 1;">
	    	...
	    	<output style="align:left;background-color:orange;">::${item.title}::</output>
	    	<output style="align:left;background-color:red;">${item.news}</output>
